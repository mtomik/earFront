...
class TrainerParams(forms.Form):
    ...
    precalcValBuf = forms.FloatField(label='precalcValBuf', min_value=500, max_value=6000, initial=1500, required=False)
    precalcIdxBuf = forms.FloatField(label='precalcIdxBuf', min_value=500, max_value=6000, initial=1000, required=False)
